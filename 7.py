...
def processline(game):
    ...
    #hand = list(dict.fromkeys(list(copy.deepcopy(hand0))))
...
def test_processline():
    ...
    myassert(('T55J5',765,[3,1,1]  ,'3','1005051105', '41005051105'),processline(('T55J5',765)))
    myassert(('KK677',765,[2,2,1] ,'22','1313060707', '31313060707'),processline(('KK677',765)))
    myassert(('KTJJT',765,[2,2,1] ,'22','1310111110', '31310111110'),processline(('KTJJT',765)))
    myassert(('QQQJA',765,[3,1,1]  ,'3','1212121114', '41212121114'),processline(('QQQJA',765)))
    myassert(('4'),processline(('QQQJQ',765))[3])
    ...
    myassert(('61212121112'),processline(('QQQJQ',765))[5])
